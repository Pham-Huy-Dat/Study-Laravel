        ...
        <section class="main">
            <div class="product-full">
                <div class="grid">
                    ...
                    @endif
                    {{-- <form action="{{ URL::to('/save-checkout') }}" method="post" class="cart-form">
                        @csrf --}}
                        <div class="cart-info">
                            <div>
                                <div class="cart-info__detail">
                                                            ...
                                                            <td class="cart-product-edit">
                                                                <ul class="cart-product-edit__list">
                                                                    <li class="cart-product-edit__item">
                                                                        <a
                                                                            href="{{ URL::to('/delete-product/' . $item->rowId) }}">Xóa</a>
                                                                    </li>
                                                                </ul>
                                                            </td>
                                                            {{-- @* END DELETE *@ --}}
                                    ...
                                    <div class="cart-info__detail-btn">
                                        ...
                                        <button type="submit" style="margin-right: 20px; color:blue" id="btnUpdate">
                                            <a href="{{ URL::to('/update-product') }}">
                                                Cập nhật giỏ hàng
                                            </a>
                                        </button>

                                        <button style="color:blue" type="butoon">
                                            <a href="{{ URL::to('/') }}">
                                                Tiếp tục mua sắm
                                            </a>
                                        </button>
                            ...
                            <form action="{{URl::to('/save_checkout_customer')}}" method="POST">
                                ...
                                <div class="cart-info__billing">
                                    ...
                                    <input class="cart-info__billing-name" type="text" placeholder="Tên" name="NameCus"
                                        required>
