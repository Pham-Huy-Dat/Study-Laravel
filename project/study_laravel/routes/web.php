...
//gio hang// cart
Route::post('/update-cart', [CartController::class, 'update_product'])->name('cart.update-product');
...
Route::get('/delete-cart-product/{rowId}', [CartController::class, 'delete_product'])->name('cart.delete-product');
...
Route::get('/logout_admin', [AdminController::class, 'logout'])->name('Admin.logout_admin');


//Admin -- quann ly san pham=..  = - =
Route::get('/admin', [AdminController::class, 'index'])->name('Admin.index_admin');
...
Route::get('/edit-product/{id}', [AdminController::class, 'view_edit_product'])->name('Admin.view_edit_product');
Route::post('/edit-product/{id}', [AdminController::class, 'edit_product'])->name('Admin.edit_product');

Route::get('/admin-delete-product/{id}', [AdminController::class, 'delete_product'])->name('Admin.delete_product');

// order
Route::get('/order-admin', [AdminController::class, 'order'])->name('Admin.order');
Route::get('/order-detail-admin/{id}', [AdminController::class, 'order_detail'])->name('Admin.order_detail');

Route::get('/order-browsing/{id}', [AdminController::class, 'order_browsing'])->name('Admin.order_browsing');
Route::get('/cancel_order/{id}', [AdminController::class, 'cancel_order'])->name('Admin.cancel_order');
Route::get('/delete-order/{id}', [AdminController::class, 'delete_order'])->name('Admin.delete_order');
